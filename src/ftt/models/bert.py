...
from ftt.config import bertConfig, Config
configs = Config()
berts = bertConfig()
...
class BERTfinetuning:
    def __init__(self, dataset, training_args):
        self.model_name = berts.HF_MODEL_NAME
    ...
    def compute_metrics(
        ...
        return self.metric.compute(
            predictions=predictions, references=labels, average=berts.F1_AVG
        )
